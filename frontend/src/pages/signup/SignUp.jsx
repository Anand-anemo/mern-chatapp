    ...
    <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
        ...
        bg-opacity-0'>
            <h1 className='text-3xl font-semibold text-center text-gray-300'>
                SignUp
                <span className='text-blue-900'>Vchat</span>
            </h1>
            ...
            <form onSubmit={handleSubmit} >
                ...
                <Link to="/login" className='text-sm hover:underline hover:text-blue-200 mt-2 inline-block text-gray-500'>
                    Already have an Account ?
                </Link>

                <div>
                    <button className='btn btn-block btn-sm mt-2 hover:bg-gray-700' disabled={loading}>
