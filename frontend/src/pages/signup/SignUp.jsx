        ...
        bg-opacity-0'>
            ...
            <form >
                <div>
                    ...
                    <input type='text' placeholder='Name' className='w-full input input-bordered h-10'></input>
                </div>
                ...
                <a href="#" className='text-sm hover:underline hover:text-blue-200 mt-2 inline-block text-indigo-950'>
